...
class BusinessProfilesRepository {
    ...
    fun getBusinessProfileCategories(callback: (ResponseBodyState) -> Unit) {
        ...
        apiService.getBusinessProfileCategories()
            .enqueue(object : Callback<ResponseDataList<BusinessCategory>> {
                override fun onResponse(
                    call: Call<ResponseDataList<BusinessCategory>>,
                    response: Response<ResponseDataList<BusinessCategory>>
                ) {
    ...
    fun getBusinessProfilesWithPagination(start: Long, callback: (ResponseBodyState) -> Unit) {
        ...
        apiService.getBusinessProfilesWithPagination(start = start, limit = LIMIT_REGULAR)
            .enqueue(object : Callback<ResponseDataList<BusinessProfile>> {
                override fun onResponse(
                    call: Call<ResponseDataList<BusinessProfile>>,
                    response: Response<ResponseDataList<BusinessProfile>>
                ) {
                    if (response.isSuccessful) {
    ...
    fun getSimilarBusinessProfileCategories(
        ...
        apiService.getSimilarBusinessProfileCategories(id)
            .enqueue(object : Callback<ResponseDataList<BusinessCategory>> {
                override fun onResponse(
                    call: Call<ResponseDataList<BusinessCategory>>,
                    response: Response<ResponseDataList<BusinessCategory>>
                    ...
                    if (response.isSuccessful) {
                        ...
                        Log.e("BusinessCategoryRepo", "Error: ${response.code()}")
                        callback(ResponseBodyState.Error(UNSUCCESSFUL_RESPONSE))
                    }
                }
                ...
                override fun onFailure(
                    ...
                    Log.e("BusinessCategoryRepo", "Failure: ${t.message}")
                    callback(ResponseBodyState.Error(RESPONSE_FAILURE))
                }
            })
    }
    ...
    fun getCategoryProducts(
        ...
        callback(ResponseBodyState.Loading)
        apiService.getSubCategoryProducts(categoryId = categoryId, offset = offset, limit = limit)
            .enqueue(object : Callback<ResponseDataList<CategoryProduct>> {
                override fun onResponse(
                    call: Call<ResponseDataList<CategoryProduct>>,
                    response: Response<ResponseDataList<CategoryProduct>>
                ) {
                    if (response.isSuccessful) {
                        val businessProfiles = response.body()?.data ?: emptyList()
                        callback(ResponseBodyState.SuccessList(businessProfiles))
