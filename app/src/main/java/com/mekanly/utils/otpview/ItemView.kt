package com.mekanly.utils.otpview
...
import com.mekanly.utils.extensions.getPixels
...
class ItemView : FrameLayout {
    ...
    private fun generateViews(styles: TypedArray) {
        val defaultHeight = getPixels(context, DEFAULT_BAR_HEIGHT).toFloat()
        val defaultOtpTextSize = getPixels(context, DEFAULT_OTP_TEXT_SIZE).toFloat()
        ...
        val barMargin = styles.getDimension(R.styleable.OtpTextView_bar_margin, getPixels(
            context,
            0
        ).toFloat())
...
//        hideOTPDrawable = styles.getResourceId(R.styleable.OtpTextView_hide_otp_drawable, R.drawable.ic_add)

        defaultOTPDrawable = ResourcesCompat.getColor(context.resources, R.color.color_transparent, null)
        ...
        val boxBackgroundColor = styles.getResourceId(R.styleable.OtpTextView_otp_box_background, ResourcesCompat.getColor(context.resources, R.color.color_transparent, null))
        ...
        barActiveColor = styles.getColor(R.styleable.OtpTextView_bar_active_color, ResourcesCompat.getColor(context.resources, R.color.text_color, null))
        barInactiveColor = styles.getColor(R.styleable.OtpTextView_bar_inactive_color, ResourcesCompat.getColor(context.resources, R.color.grey_text_color, null))
        barErrorColor = styles.getColor(R.styleable.OtpTextView_bar_error_color, ResourcesCompat.getColor(context.resources, R.color.error, null))
        barSuccessColor = styles.getColor(R.styleable.OtpTextView_bar_success_color, ResourcesCompat.getColor(context.resources, R.color.text_color, null))
