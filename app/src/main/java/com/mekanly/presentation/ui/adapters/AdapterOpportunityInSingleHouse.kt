...
class AdapterOpportunityInSingleHouse(private val items: List<DataPossibility>) : RecyclerView.Adapter<AdapterOpportunityInSingleHouse.HouseViewHolder>() {
